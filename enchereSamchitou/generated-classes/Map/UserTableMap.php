...
class UserTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdUser', 'Login', 'Nom', 'Prenom', 'Ville', 'Role', ),
        self::TYPE_CAMELNAME     => array('idUser', 'login', 'nom', 'prenom', 'ville', 'role', ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_ID_USER, UserTableMap::COL_LOGIN, UserTableMap::COL_NOM, UserTableMap::COL_PRENOM, UserTableMap::COL_VILLE, UserTableMap::COL_ROLE, ),
        self::TYPE_FIELDNAME     => array('id_user', 'login', 'nom', 'prenom', 'ville', 'role', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdUser' => 0, 'Login' => 1, 'Nom' => 2, 'Prenom' => 3, 'Ville' => 4, 'Role' => 5, ),
        self::TYPE_CAMELNAME     => array('idUser' => 0, 'login' => 1, 'nom' => 2, 'prenom' => 3, 'ville' => 4, 'role' => 5, ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_ID_USER => 0, UserTableMap::COL_LOGIN => 1, UserTableMap::COL_NOM => 2, UserTableMap::COL_PRENOM => 3, UserTableMap::COL_VILLE => 4, UserTableMap::COL_ROLE => 5, ),
        self::TYPE_FIELDNAME     => array('id_user' => 0, 'login' => 1, 'nom' => 2, 'prenom' => 3, 'ville' => 4, 'role' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('nom', 'Nom', 'VARCHAR', false, 35, null);
        $this->addColumn('prenom', 'Prenom', 'VARCHAR', false, 35, null);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserTableMap::COL_VILLE);
