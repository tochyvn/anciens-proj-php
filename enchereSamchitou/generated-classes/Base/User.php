...
abstract class User implements ActiveRecordInterface
{
    ...
    public function setVille($v)
    {
        ...
        if ($this->ville !== $v) {
            $this->ville = $v;
            $this->modifiedColumns[UserTableMap::COL_VILLE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UserTableMap::translateFieldName('Ville', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_VILLE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_VILLE)) {
            $criteria->add(UserTableMap::COL_VILLE, $this->ville);
        }
        if ($this->isColumnModified(UserTableMap::COL_ROLE)) {
