...
class AchatTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('DateAchat', 'Pseudo', 'IdPack', ),
        self::TYPE_CAMELNAME     => array('dateAchat', 'pseudo', 'idPack', ),
        self::TYPE_COLNAME       => array(AchatTableMap::COL_DATE_ACHAT, AchatTableMap::COL_PSEUDO, AchatTableMap::COL_ID_PACK, ),
        self::TYPE_FIELDNAME     => array('date_achat', 'pseudo', 'id_pack', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('DateAchat' => 0, 'Pseudo' => 1, 'IdPack' => 2, ),
        self::TYPE_CAMELNAME     => array('dateAchat' => 0, 'pseudo' => 1, 'idPack' => 2, ),
        self::TYPE_COLNAME       => array(AchatTableMap::COL_DATE_ACHAT => 0, AchatTableMap::COL_PSEUDO => 1, AchatTableMap::COL_ID_PACK => 2, ),
        self::TYPE_FIELDNAME     => array('date_achat' => 0, 'pseudo' => 1, 'id_pack' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('date_achat', 'DateAchat', 'VARCHAR', true, 14, null);
  ...
  array (
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (null === $key) {
                $key = serialize(array((string) $obj->getDateAchat(), (string) $obj->getPseudo(), (string) $obj->getIdPack()));
            } // if key === null
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Achat) {
                $key = serialize(array((string) $value->getDateAchat(), (string) $value->getPseudo(), (string) $value->getIdPack()));
     ...
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                ...
                $criterion->addAnd($criteria->getNewCriterion(AchatTableMap::COL_ID_PACK, $value[2]));
