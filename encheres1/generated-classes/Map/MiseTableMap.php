...
class MiseTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Prix', 'Pseudo', 'IdEnch', ),
        self::TYPE_CAMELNAME     => array('prix', 'pseudo', 'idEnch', ),
        self::TYPE_COLNAME       => array(MiseTableMap::COL_PRIX, MiseTableMap::COL_PSEUDO, MiseTableMap::COL_ID_ENCH, ),
        self::TYPE_FIELDNAME     => array('prix', 'pseudo', 'id_ench', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Prix' => 0, 'Pseudo' => 1, 'IdEnch' => 2, ),
        self::TYPE_CAMELNAME     => array('prix' => 0, 'pseudo' => 1, 'idEnch' => 2, ),
        self::TYPE_COLNAME       => array(MiseTableMap::COL_PRIX => 0, MiseTableMap::COL_PSEUDO => 1, MiseTableMap::COL_ID_ENCH => 2, ),
        self::TYPE_FIELDNAME     => array('prix' => 0, 'pseudo' => 1, 'id_ench' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('prix', 'Prix', 'DECIMAL', true, null, null);
  ...
  array (
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (null === $key) {
                $key = serialize(array((string) $obj->getPrix(), (string) $obj->getPseudo(), (string) $obj->getIdEnch()));
            } // if key === null
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Mise) {
                $key = serialize(array((string) $value->getPrix(), (string) $value->getPseudo(), (string) $value->getIdEnch()));
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Prix', TableMap::TYPE_PHPNAME, $indexType)] === null && $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('Pseudo', TableMap::TYPE_PHPNAME, $indexType)] === null && $row[TableMap::TYPE_NUM == $indexType ? 2 + $offset : static::translateFieldName('IdEnch', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return serialize(array((string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Prix', TableMap::TYPE_PHPNAME, $indexType)], (string) $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('Pseudo', TableMap::TYPE_PHPNAME, $indexType)], (string) $row[TableMap::TYPE_NUM == $indexType ? 2 + $offset : static::translateFieldName('IdEnch', TableMap::TYPE_PHPNAME, $indexType)]));
    }
     ...
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(MiseTableMap::COL_PRIX, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(MiseTableMap::COL_PSEUDO, $value[1]));
                $criterion->addAnd($criteria->getNewCriterion(MiseTableMap::COL_ID_ENCH, $value[2]));
