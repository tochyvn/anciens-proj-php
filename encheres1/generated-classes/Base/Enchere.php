...
abstract class Enchere implements ActiveRecordInterface
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : EnchereTableMap::translateFieldName('IdArt', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = EnchereTableMap::NUM_HYDRATE_COLUMNS.
