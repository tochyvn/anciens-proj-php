...
class AchatTableMap extends TableMap
{
    ...
    /**
     * the column name for the dateAcht field
     */
    const COL_DATEACHT = 'Achat.dateAcht';

    /**
     * the column name for the email field
     */
    const COL_EMAIL = 'Achat.email';

    /**
     * the column name for the id field
     */
    const COL_ID = 'Achat.id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Dateacht', 'Email', 'Id', ),
        self::TYPE_CAMELNAME     => array('dateacht', 'email', 'id', ),
        self::TYPE_COLNAME       => array(AchatTableMap::COL_DATEACHT, AchatTableMap::COL_EMAIL, AchatTableMap::COL_ID, ),
        self::TYPE_FIELDNAME     => array('dateAcht', 'email', 'id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Dateacht' => 0, 'Email' => 1, 'Id' => 2, ),
        self::TYPE_CAMELNAME     => array('dateacht' => 0, 'email' => 1, 'id' => 2, ),
        self::TYPE_COLNAME       => array(AchatTableMap::COL_DATEACHT => 0, AchatTableMap::COL_EMAIL => 1, AchatTableMap::COL_ID => 2, ),
        self::TYPE_FIELDNAME     => array('dateAcht' => 0, 'email' => 1, 'id' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('dateAcht', 'Dateacht', 'DATE', true, null, null);
        $this->addForeignKey('email', 'Email', 'VARCHAR', 'Utilisateur', 'email', false, 25, null);
        $this->addForeignKey('id', 'Id', 'INTEGER', 'Jetons', 'id', false, null, null);
    } // initialize()
  ...
  array (
    ...
    1 => ':email',
        ...
        $this->addRelation('Jetons', '\\Jetons', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':id',
    1 => ':id',
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Dateacht', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Dateacht', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    public static function getPrimaryKeyFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        return (string) $row[
            $indexType == TableMap::TYPE_NUM
                ? 0 + $offset
                : self::translateFieldName('Dateacht', TableMap::TYPE_PHPNAME, $indexType)
        ];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(AchatTableMap::COL_DATEACHT);
            $criteria->addSelectColumn(AchatTableMap::COL_EMAIL);
            $criteria->addSelectColumn(AchatTableMap::COL_ID);
        } else {
            $criteria->addSelectColumn($alias . '.dateAcht');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(AchatTableMap::COL_DATEACHT, (array) $values, Criteria::IN);
        }
