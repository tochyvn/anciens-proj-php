...
class UtilisateurTableMap extends TableMap
{
     ...
     */
    const COL_PSEUDO = 'Utilisateur.pseudo';

    /**
     * the column name for the role field
     */
    const COL_ROLE = 'Utilisateur.role';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Email', 'Password', 'Pseudo', 'Role', ),
        self::TYPE_CAMELNAME     => array('email', 'password', 'pseudo', 'role', ),
        self::TYPE_COLNAME       => array(UtilisateurTableMap::COL_EMAIL, UtilisateurTableMap::COL_PASSWORD, UtilisateurTableMap::COL_PSEUDO, UtilisateurTableMap::COL_ROLE, ),
        self::TYPE_FIELDNAME     => array('email', 'password', 'pseudo', 'role', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Email' => 0, 'Password' => 1, 'Pseudo' => 2, 'Role' => 3, ),
        self::TYPE_CAMELNAME     => array('email' => 0, 'password' => 1, 'pseudo' => 2, 'role' => 3, ),
        self::TYPE_COLNAME       => array(UtilisateurTableMap::COL_EMAIL => 0, UtilisateurTableMap::COL_PASSWORD => 1, UtilisateurTableMap::COL_PSEUDO => 2, UtilisateurTableMap::COL_ROLE => 3, ),
        self::TYPE_FIELDNAME     => array('email' => 0, 'password' => 1, 'pseudo' => 2, 'role' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('email', 'Email', 'VARCHAR', true, 25, null);
        $this->addColumn('password', 'Password', 'VARCHAR', false, 25, null);
        $this->addColumn('pseudo', 'Pseudo', 'INTEGER', false, null, null);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UtilisateurTableMap::COL_PSEUDO);
            $criteria->addSelectColumn(UtilisateurTableMap::COL_ROLE);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(UtilisateurTableMap::COL_EMAIL, (array) $values, Criteria::IN);
        }
