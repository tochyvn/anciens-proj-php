...
class MiseTableMap extends TableMap
{
    ...
    /**
     * the column name for the dateProposition field
     */
    const COL_DATEPROPOSITION = 'Mise.dateProposition';

    /**
     * the column name for the email field
     */
    const COL_EMAIL = 'Mise.email';

    /**
     * the column name for the id field
     */
    const COL_ID = 'Mise.id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Prix', 'Dateproposition', 'Email', 'Id', ),
        self::TYPE_CAMELNAME     => array('prix', 'dateproposition', 'email', 'id', ),
        self::TYPE_COLNAME       => array(MiseTableMap::COL_PRIX, MiseTableMap::COL_DATEPROPOSITION, MiseTableMap::COL_EMAIL, MiseTableMap::COL_ID, ),
        self::TYPE_FIELDNAME     => array('prix', 'dateProposition', 'email', 'id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Prix' => 0, 'Dateproposition' => 1, 'Email' => 2, 'Id' => 3, ),
        self::TYPE_CAMELNAME     => array('prix' => 0, 'dateproposition' => 1, 'email' => 2, 'id' => 3, ),
        self::TYPE_COLNAME       => array(MiseTableMap::COL_PRIX => 0, MiseTableMap::COL_DATEPROPOSITION => 1, MiseTableMap::COL_EMAIL => 2, MiseTableMap::COL_ID => 3, ),
        self::TYPE_FIELDNAME     => array('prix' => 0, 'dateProposition' => 1, 'email' => 2, 'id' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('prix', 'Prix', 'INTEGER', true, null, null);
        $this->addColumn('dateProposition', 'Dateproposition', 'DATE', false, null, null);
        $this->addForeignKey('email', 'Email', 'VARCHAR', 'Utilisateur', 'email', false, 25, null);
        $this->addForeignKey('id', 'Id', 'INTEGER', 'Enchere', 'id', false, null, null);
    } // initialize()
  ...
  array (
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Prix', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Prix', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(MiseTableMap::COL_DATEPROPOSITION);
            $criteria->addSelectColumn(MiseTableMap::COL_EMAIL);
            $criteria->addSelectColumn(MiseTableMap::COL_ID);
        } else {
            $criteria->addSelectColumn($alias . '.prix');
            $criteria->addSelectColumn($alias . '.dateProposition');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(MiseTableMap::COL_PRIX, (array) $values, Criteria::IN);
        }
