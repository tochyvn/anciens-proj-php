...
abstract class Enchere implements ActiveRecordInterface
{
    ...
    public function getDatedebut($format = NULL)
    {
        if ($format === null) {
            ...
            return $this->datedebut instanceof \DateTime ? $this->datedebut->format($format) : null;
        }
    }
    ...
    public function getDatefin($format = NULL)
    {
        if ($format === null) {
            ...
            return $this->datefin instanceof \DateTime ? $this->datefin->format($format) : null;
        }
    }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[EnchereTableMap::COL_ID] = true;
        }
    ...
    public function setDatedebut($v)
    {
        ...
        if ($this->datedebut !== null || $dt !== null) {
            if ($dt !== $this->datedebut) {
                $this->datedebut = $dt;
                $this->modifiedColumns[EnchereTableMap::COL_DATEDEBUT] = true;
            }
    ...
    public function setDatefin($v)
    {
        ...
        if ($this->datefin !== null || $dt !== null) {
            if ($dt !== $this->datefin) {
                $this->datefin = $dt;
                $this->modifiedColumns[EnchereTableMap::COL_DATEFIN] = true;
            }
        } // if either are not null
    ...
    public function setReference($v)
    {
        ...
        if ($this->reference !== $v) {
            $this->reference = $v;
            $this->modifiedColumns[EnchereTableMap::COL_REFERENCE] = true;
        }

        if ($this->aProduit !== null && $this->aProduit->getReference() !== $v) {
            $this->aProduit = null;
        }
    ...
    public function setDesignation($v)
    {
        ...
        if ($this->designation !== $v) {
            $this->designation = $v;
            $this->modifiedColumns[EnchereTableMap::COL_DESIGNATION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EnchereTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $this->datedebut = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EnchereTableMap::translateFieldName('Datefin', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->datefin = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : EnchereTableMap::translateFieldName('Reference', TableMap::TYPE_PHPNAME, $indexType)];
            $this->reference = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : EnchereTableMap::translateFieldName('Designation', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = EnchereTableMap::NUM_HYDRATE_COLUMNS.
    ...
    {
        if ($this->aProduit !== null && $this->reference !== $this->aProduit->getReference()) {
            $this->aProduit = null;
        }
    } // ensureConsistency
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->misesScheduledForDeletion !== null) {
                if (!$this->misesScheduledForDeletion->isEmpty()) {
                    foreach ($this->misesScheduledForDeletion as $mise) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(EnchereTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(EnchereTableMap::COL_DATEDEBUT)) {
            $modifiedColumns[':p' . $index++]  = 'dateDebut';
        }
        if ($this->isColumnModified(EnchereTableMap::COL_DATEFIN)) {
            $modifiedColumns[':p' . $index++]  = 'dateFin';
        }
        if ($this->isColumnModified(EnchereTableMap::COL_REFERENCE)) {
            $modifiedColumns[':p' . $index++]  = 'reference';
        }
        if ($this->isColumnModified(EnchereTableMap::COL_DESIGNATION)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'dateDebut':
                        $stmt->bindValue($identifier, $this->datedebut ? $this->datedebut->format("Y-m-d H:i:s") : null, PDO::PARAM_STR);
                        break;
                    case 'dateFin':
                        $stmt->bindValue($identifier, $this->datefin ? $this->datefin->format("Y-m-d H:i:s") : null, PDO::PARAM_STR);
                        break;
                    case 'reference':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aProduit) {
                ...
                $result[$key] = $this->aProduit->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setDatefin($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setReference($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setDesignation($arr[$keys[4]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EnchereTableMap::COL_ID)) {
            $criteria->add(EnchereTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(EnchereTableMap::COL_DATEDEBUT)) {
            $criteria->add(EnchereTableMap::COL_DATEDEBUT, $this->datedebut);
        }
        if ($this->isColumnModified(EnchereTableMap::COL_DATEFIN)) {
            $criteria->add(EnchereTableMap::COL_DATEFIN, $this->datefin);
        }
        if ($this->isColumnModified(EnchereTableMap::COL_REFERENCE)) {
            $criteria->add(EnchereTableMap::COL_REFERENCE, $this->reference);
        }
        if ($this->isColumnModified(EnchereTableMap::COL_DESIGNATION)) {
            $criteria->add(EnchereTableMap::COL_DESIGNATION, $this->designation);
        }
    ...
    /**
     * Declares an association between this object and a ChildProduit object.
     *
     * @param  ChildProduit $v
     * @return $this|\Enchere The current object (for fluent API support)
     * @throws PropelException
     */
    public function setProduit(ChildProduit $v = null)
    {
        if ($v === null) {
        ...
        // If this object has already been added to the ChildProduit object, it will not be re-added.
        if ($v !== null) {
            $v->addEnchere($this);
        }
    ...
    /**
     * Get the associated ChildProduit object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildProduit The associated ChildProduit object.
     * @throws PropelException
     */
    public function getProduit(ConnectionInterface $con = null)
    {
        if ($this->aProduit === null && ($this->reference !== null)) {
            $this->aProduit = ChildProduitQuery::create()
                ->filterByEnchere($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                ...
                $this->aProduit->addEncheres($this);
             */
        }
    ...
    public function setMises(Collection $mises, ConnectionInterface $con = null)
    {
        ...
        $this->misesScheduledForDeletion = $misesToDelete;
    ...
    public function removeMise(ChildMise $mise)
    {
        if ($this->getMises()->contains($mise)) {
            ...
            $this->misesScheduledForDeletion[]= $mise;
     ...
     * @return ObjectCollection|ChildMise[] List of ChildMise objects
     */
    public function getMisesJoinUtilisateur(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildMiseQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aProduit) {
            $this->aProduit->removeEnchere($this);
        }
        $this->id = null;
        $this->datedebut = null;
        $this->datefin = null;
