...
class MNOR extends MIOSommet{
    ...
    function __construct($id,$descr) {
        ...
        $this->setCode_objet(3); //--- Ce code represente le nbr de pattes
    ...
    public function toHTML() {
        $attr=array('left'=>$this->getPosition()->getX(),'right'=>  $this->getPosition()->getY(),'width'=>  $this->getLarge(),'height'=>  $this->getHauteur(),'name'=>'NOR.png','code'=>$this->getCode_objet(),'e1'=>'FALSE','e2'=>'FALSE','s'=>'FALSE');
        return $attr;
    }
