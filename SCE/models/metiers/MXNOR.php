...
class MXNOR extends MIOSommet{
    ...
    public function toHTML() {
        $attr=array('left'=>$this->getPosition()->getX(),'right'=>  $this->getPosition()->getY(),'width'=>  $this->getLarge(),'height'=>  $this->getHauteur(),'name'=>'XNOR.png','code'=>$this->getCode_objet(),'e1'=>'FALSE','e2'=>'FALSE','s'=>'FALSE');
        return $attr;
    }
