...
?>
    <tr id="<?php print('position'.$i);?>">
      <td><a name="<?php print($i);?>" id="ancre<?php print($i);?>"></a><div id="provenance"><img src="<?php print(URL_INCLUSION.'gd.php?forme=rectangle&x=8&y=8&c='.urlencode($annonce_liste->occurrence[$i]['provenance_couleur']));?>" alt="<?php print(ma_htmlentities($annonce_liste->occurrence[$i]['provenance_designation']))?>" title="<?php print(ma_htmlentities($annonce_liste->occurrence[$i]['provenance_designation']))?>" /></div>
        <div id="image"><?php if($annonce_liste->occurrence[$i]['image']!==NULL) print('<a onclick="document.getElementById(\''.'image'.$i.'\').style.backgroundImage=\'url(../image/annonce_url2_sombre.jpg)\';" href="'.$annonce_liste->occurrence[$i]['url'].'" target="_blank"><img src="'.$annonce_liste->occurrence[$i]['image'].'" style="border:none;" /></a>');?></div>
        ...
        <div id="contact">&nbsp;</div>
        <div id="url2"><?php if($annonce_liste->occurrence[$i]['url']!='') print('<a id="image'.$i.'" onclick="this.style.backgroundImage=\'url(../image/annonce_url2_sombre.jpg)\';" href="'.$annonce_liste->occurrence[$i]['url'].'" target="_blank">Consultez la suite de l\'annonce ici</a>'); else print('<a id="image'.$i.'" onclick="this.style.backgroundImage=\'url(../image/annonce_url2_sombre.jpg)\';" href="'.$provenance[$annonce_liste->occurrence[$i]['provenance_identifiant']].'" target="_blank">Retrouvez l\'annonce sur '.$annonce_liste->occurrence[$i]['provenance_designation'].'</a>')?></div>
        ...
        <div id="abus"><a href="<?php print(URL_ADHERENT_V2.'annonce/abus.php?annonce_identifiant='.urlencode($annonce_liste->occurrence[$i]['identifiant']));?>"><img src="<?php print(URL_ADHERENT_V2.'image/abus.jpg');?>" alt="Signaler un incident" title="Signaler un incident"></a></div>
        </td>
    </tr>
    <?php
