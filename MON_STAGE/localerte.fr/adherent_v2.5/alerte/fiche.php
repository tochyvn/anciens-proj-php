...
?>
      ...
      <div class="alerte">
        <form action="fiche.php" class="alerte">
          <p><br />
            <label>Ville : </label>
            <input class="js-label js-localisation" type="text" name="alerte_filtre" value="<?php print(((isset($_REQUEST['alerte_filtre']))?(ma_htmlentities($_REQUEST['alerte_filtre'])):('')));?>" title="Saisissez la ville ou code postal" onchange="js_localisation_changer($(this),$('input[name=&quot;alerte_ville&quot;]'));" />
		...
		{
			if($j<sizeof($objet->alerte_type)) $type=$objet->alerte_type[$j]['objet']->nouveau_type;
			else $type=NULL;
  ?>
