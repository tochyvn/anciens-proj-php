...
?>
      ...
      <div class="alerte">
        <form action="liste.php" class="alerte">
          ...
          <p><br />
            <label>Ville : </label>
            <input class="js-autocomplete lt_general" type="text" name="alerte_filtre_<?php print($i);?>" id="lt_general_<?php print($i);?>" value="<?php print(((isset($_REQUEST['alerte_filtre_'.$i]))?(ma_htmlentities($_REQUEST['alerte_filtre_'.$i])):('Saisissez la ville ou code postal')));?>" />
			<?php
	print('<br /><select name="alerte_ville" id="ls_general_'.$i.'" class="ls_general" size="10">');
