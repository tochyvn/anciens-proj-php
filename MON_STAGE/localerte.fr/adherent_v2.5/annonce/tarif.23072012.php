    ...
    <table>
      <tr>
        <td colspan="4" width="655"><table cellpadding="0" cellspacing="0" width="655">
            <tr>
              <td width="655" style="padding:5px; padding-left:10px; background-color:#D8E3F0;"><h3 style="color:#FF7602; font-size:16px;">Consultation sans abonnement</h3>
                <script type="text/javascript">
				  <!--
                ...
                <script type="text/javascript">
				  <!--
					document.write('<span class="bulle fleche-haut-gauche" style="top:528px; left:20px; width:300px; display:none;" id="aide2b">');
					document.write('<span class="cadre">');
					document.write('<span class="haut-gauche"></span>');
					document.write('<span class="haut-centre"></span>');
					document.write('<span class="haut-droite"></span>');
                ...
                <span style="color:#e57503; font-size:12px;">Consultez juste le temps de votre session <a href="#" onmouseover="document.getElementById('aide1a').style.display='block';" onmouseout="document.getElementById('aide1a').style.display='none';" style="color:#FF7602; padding-left:120px; font-size:11px;">En savoir plus ?</a></span></td>
              <td></td>
            </tr>
          </table></td>
      </tr>
      <tr>
        <td valign="top" width="315" style="background-image:url(<?php print(URL_ADHERENT.'image/paiement/v6/fleche_grosse.jpg');?>); background-position:right; background-repeat:no-repeat; font-size:13px; font-weight:bold; padding-left:10px;"><br />
          ...
          <br />
          <!--b><a href="#" onmouseover="document.getElementById('aide2a').style.display='block';" onmouseout="document.getElementById('aide2a').style.display='none';" style="color:#195292; font-size:13px; font-weight:bold;">Pourquoi r&eacute;gler par SMS ou 08 99 ?</a></b-->
          <br /></td>
        <td width="10">&nbsp;</td>
        <td width="580"><table cellpadding="0" cellspacing="0" width="580">
            <tr>
              <td width="100" style="padding-left:10px; background-color:#D8E3F0;"><img src="<?php print(URL_ADHERENT.'image/paiement/v6/sms.jpg');?>" alt="SMS" /> <img src="<?php print(URL_ADHERENT.'image/paiement/v6/fleche_bleue.jpg');?>" alt="&gt;" style="padding-bottom:10px; padding-left:5px;" /></td>
              <td style="padding:8px; background-color:#D8E3F0;" width="200"><table cellpadding="0" cellspacing="0" width="180" style="background-color:#FF7602; background-image:url('<?php print(URL_ADHERENT.'image/paiement/v6/fond_sansabo.jpg');?>');">
                  <tr>
                    <td colspan="3" align="center" style="color:#FFFFFF; height:21px;">Envoyez LOC</td>
                  </tr>
                  <tr>
                    <td width="3"></td>
                    <td align="center" style="background-color:#FFFFFF; color:#FF7602; height:19px;"><b>au 81 083 *</b></td>
                    <td width="3"></td>
                  </tr>
                </table></td>
              <td width="280" rowspan="2" align="center" style="background-color:#D8E3F0; aborder:solid 5px #FF7602; color:#FF7602; padding:5px; width:210px;"><b>Validez ici le code obtenu :</b><br />
                <form action="<?php print(URL_ADHERENT.'annonce/tarif.php');?>" method="post" class="code">
                  <p>
                    <input type="hidden" name="formulaire1" value="" />
                    <img src="<?php print(URL_ADHERENT.'image/paiement/v6/fleche_orange.gif');?>" alt="&gt;" style="vertical-align:middle" />
                    <input type="text" id="code_reference" name="code_reference" style="vertical-align:middle; border:solid 1px #CCCCCC; width:120px; height:20px; font-size:14px; text-align:center; margin:5px;" />
                    <br />
                    <input type="submit" style="font-family:Arial, Helvetica, sans-serif;  background-image:url(<?php print(URL_ADHERENT.'image/paiement/v6/bouton.jpg');?>); font-size:14px; font-weight:bold; color:#FFF; cursor:pointer; width:145px; height:30px; text-align:center;" name="code_submit" value="Valider" />
                  </p>
                </form>
                <br />
                <?php if(isset($_REQUEST['formulaire1'])) { ?>
                <span style="color:#A12104; font-size:12px; font-weight:bold;">Code incorrect<br />&nbsp;</span>
                <?php } else { ?>
                <span style="color:#195292; font-size:11px;">En validant, vous passerez<br />
                automatiquement en acc&egrave;s libre</span>
                <?php } ?>
              </td>
            </tr>
            <tr>
              <td style="padding-left:10px; background-color:#D8E3F0;"><img src="<?php print(URL_ADHERENT.'image/paiement/v6/tel.jpg');?>" alt="TEL" /> <img src="<?php print(URL_ADHERENT.'image/paiement/v6/fleche_bleue.jpg');?>" alt="&gt;" style="padding-bottom:10px; padding-left:5px;" /></td>
              <td style="padding:8px; background-color:#D8E3F0;"><table cellpadding="0" cellspacing="0" width="180" style="background-color:#FF7602; background-image:url('<?php print(URL_ADHERENT.'image/paiement/v6/fond_sansabo.jpg');?>');">
                  <tr>
                    <td colspan="3" align="center" style="color:#FFFFFF; height:21px;">Appelez le</td>
                  </tr>
                  <tr>
                    <td width="3"></td>
                    <td bgcolor="#FFFFFF" align="center" style="color:#FF7602; height:19px;"><b>08 99 23 08 89 *</b></td>
                    <td width="3"></td>
                  </tr>
                </table></td>
            </tr>
            ...
            <tr>
              <td style="padding-left:10px; background-color:#D8E3F0;" width="300" colspan="2"><script type="text/javascript">
				  <!--
					document.write('<span class="bulle fleche-bas-droite" style="top:189px; left:320px; width:300px; display:none; text-align:left;" id="aide4b">');
					document.write('<span class="cadre">');
					document.write('<span class="haut-gauche"></span>');
					document.write('<span class="haut-centre"></span>');
					document.write('<span class="haut-droite"></span>');
	  ...
	  -->
              ...
              <td align="center" width="280" valign="middle" rowspan="2"><p style="color:#C46100; font-size:15px;"><br />
                  <i>&laquo; Vous avez &eacute;t&eacute; plus de 3 000<br />
                  &agrave; nous faire confiance<br />
                  en Juin ! Merci. &raquo;</i></p></td>
            </tr>
            <tr>
              <td style="font-size:8px;" colspan="2"><br />
                * LOC par SMS au <?php print(ma_htmlentities($plateforme['S1'][1]));?> au tarif de <?php print(ma_htmlentities($plateforme['S1'][2]));?>&euro; + prix du SMS<br />
                Appel au <?php print(ma_htmlentities(formater($plateforme['FR'][1],'telephone_espace')));?> au tarif de <?php print(ma_htmlentities($plateforme['FR'][2]));?>&euro; hors surco&ucirc;t &eacute;ventuel des op&eacute;rateurs</td>
            </tr>
          </table></td>
      </tr>
      <tr>
        <td colspan="4" width="655"><table width="655" cellpadding="0" cellspacing="0">
            <tr>
              <td width="655" bgcolor="#D8E3F0" style="padding:5px; padding-left:10px;"><h3><span style="color:#e57503; font-size:16px;">Consultation avec abonnement</span></h3>
                <script type="text/javascript">
				  <!--
					document.write('<span class="bulle fleche-haut-gauche" style="top:365px; left:380px; width:300px; display:none;" id="aide3a">');
					document.write('<span class="cadre">');
					document.write('<span class="haut-gauche"></span>');
					document.write('<span class="haut-centre"></span>');
					document.write('<span class="haut-droite"></span>');
                ...
                <script type="text/javascript">
				  <!--
					document.write('<span class="bulle fleche-haut-gauche" style="top:405px; left:20px; width:300px; display:none;" id="aide3b">');
					document.write('<span class="cadre">');
					document.write('<span class="haut-gauche"></span>');
					document.write('<span class="haut-centre"></span>');
					document.write('<span class="haut-droite"></span>');
      ...
      <tr>
        <td colspan="4"><form action="<?php print(URL_ADHERENT.'annonce/tarif.php');?>" method="post" onsubmit="return GererWHA();" id="form_paiement">
            <table align="left">
              <tr>
                <td valign="top" align="left" width="315" style="background-image:url(<?php print(URL_ADHERENT.'image/paiement/v6/fleche_grosse.jpg');?>); background-position:right; background-repeat:no-repeat; font-size:13px; font-weight:bold; padding-left:10px;"><br />
                  ...
                  toutes les annonces en d&eacute;tail<br />
                  avec les coordonn&eacute;es des propri&eacute;taires,<br />
                  durant toute la dur&eacute;e de votre abonnement.<br />
                  <br /><br />
                  <b><a href="#" onmouseover="document.getElementById('aide2b').style.display='block';" onmouseout="document.getElementById('aide2b').style.display='none';" style="color:#195292; font-size:13px; font-weight:bold; color:#FF7602;">Vous disposez d'un code promo ?</a></b></td>
                <td width="10"></td>
                <td width="580" valign="top"><table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                      <td width="300" bgcolor="#FFFFFF" align="center" style="color:#E77503; font-size:14px; font-weight:bold; height:30px;">Choisissez votre formule :</td>
                      <td width="280"></td>
                    </tr>
                    <tr>
                      <td align="center" width="300" valign="top"><table cellpadding="0" cellspacing="0" style="background-color:#D8E3F0;">
                          <tr>
                      ...
                      <td align="center" width="280" valign="top"><table cellpadding="0" cellspacing="0" width="280">
                          <tr>
                            <td width="280" style="aborder:solid 5px #FF7602; background-color:#D8E3F0;; color:#FF7602; padding:5px; font-size:12px; font-weight:bold;" align="center"><b>Validez votre mode de r&eacute;glement :</b><br />
                              <script type="text/javascript">
				  <!--
					document.write('<span class="bulle fleche-bas-droite" style="top:380px; left:575px; width:300px; display:none; text-align:left;" id="aide4">');
					document.write('<span class="cadre">');
					document.write('<span class="haut-gauche"></span>');
					document.write('<span class="haut-centre"></span>');
					document.write('<span class="haut-droite"></span>');
		  ...
		  //-->
                          ...
                          <tr>
                            <td align="center"><img src="<?php print(URL_ADHERENT.'image/paiement/v6/ca.jpg');?>" alt="CB Visa Amex" /></td>
                          </tr>
                        </table></td>
                    </tr>
                  </table></td>
