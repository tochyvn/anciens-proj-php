...
<div id="principal">
  ...
  <div id="centre">
    ...
    <div class="tarif">
      <h4>Acc&egrave;s libre à la session : consultez librement tout le site, le temps de votre session</h4>
      <br />
      <h4> - Par t&eacute;l&eacute;phone ou par SMS :</h4>
      <?php
...
Votre code vous sera communiqu&eacute; par SMS si vous envoyez le mot « LOC » par SMS au 81 038,<br />ou par messagerie vocale si vous choisissez d\'appeler le 0 899 23 08 89.
	...
	?>
      <br />
      <p class="gras"> <img src="<?php print(URL_ADHERENT.'image/paiement/sms.jpg');?>" alt="Envoyer LOC par SMS au 81 038*" /> OU <img src="<?php print(URL_ADHERENT.'image/paiement/tel.jpg');?>" alt="Appeler 0 899 23 08 89*" /><br />
        <br />
	  ...
	  <!--
	  document.write('<br /><h4> - Par votre facture internet :</h4><br /><p class="gras">En choisissant cette offre, le montant de 1,50 &euro; sera d&eacute;bit&eacute; directement sur votre prochaine facture Internet.<br /><br /><a href="<?php print(LIEN_WHA);?>" id="wha"><img src="<?php print(URL_ADHERENT.'image/paiement/wha2.jpg');?>" alt="wha" /></a></p>');
	  -->
	  </script>
    </div>
    <br />
    <div class="tarif">
      ...
      <br />
      <img src="<?php print(URL_ADHERENT.'image/paiement/moyens.jpg');?>" alt="CB Mastercard Visa American Express Internet+ Paypal" /> </div>
    <br />
    <div class="tarif">
