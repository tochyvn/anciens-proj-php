...
<div id="principal">
  ...
  <div id="centre">
    <p class="lien"><a class="orange2 gras decale20d" href="<?php print(URL_ADHERENT.'annonce/liste.php');?>">Retour &agrave; la liste d'annonces</a><br />
      <br />
    </p>
    <div class="tarif">
      <?php
...
Votre code vous sera communiqu&eacute; par SMS si vous envoyez le mot « LOC » par SMS au 81 038,<br />ou par messagerie vocale si vous choisissez d\'appeler le 0 899 23 08 89.<br /><br /></p>');
      ...
      <table cellpadding="2">
        <tr>
          <td width="460"><table cellpadding="2">
              <tr>
                <td height="45" valign="middle" width="460" class="bg_bleu_fonce blanc t18 gras">Consultation par abonnement : </td>
              </tr>
              <tr>
              ...
              <tr>
                <td height="235" valign="middle" class="bg_bleu_moyen"><form action="abonnement.php" method="get">
                    <table id="abonnement_tableau">
                      <tr>
                        <td width="200"><table cellpadding="2" class="bg_bleu_fonce2 blanc decale5" width="190">
                            <tr>
                              ...
                              <td width="95" class="bg_blanc bleu_fonce2"><label for="tarif_7j" style="display:block;"><span class="t18"><b>7&euro;</b></span><br />
                                soit 1&euro;/jour</label></td>
                            </tr>
                          </table></td>
                        <td width="30"><input type="radio" name="tarif_abonnement_identifiant" value="ab0013" id="tarif_7j" /></td>
                        <td width="230"><input type="submit" class="submit simple2" name="tarif_submit" value="S'abonner" /></td>
                      </tr>
                      <tr>
                        <td width="200"><table cellpadding="2" class="bg_bleu_fonce2 blanc decale5" width="190">
                            <tr>
                              <td height="46"><label for="tarif_14j" style="display:block;"><b><span class="t18">14</span> jours</b><br />
                                <span class="t15"><b>24h/24</b></span></label></td>
                              <td width="95" class="bg_blanc bleu_fonce2"><label for="tarif_14j" style="display:block;"><span class="t18"><b>13&euro;</b></span><br />
                                au lieu de 14&euro;</label></td>
                            </tr>
                          </table></td>
                        <td width="30"><input type="radio" name="tarif_abonnement_identifiant" value="ab0014" id="tarif_14j" /></td>
                        <td rowspan="2" width="230"><input type="image" src="<?php print(URL_ADHERENT.'image/paiement/moyens.new.jpg');?>" name="tarif_submit" /></td>
                      </tr>
                      <tr>
                        <td width="200"><table cellpadding="2" class="bg_bleu_fonce2 blanc decale5" width="190">
                            <tr>
                              <td height="46"><label for="tarif_28j" style="display:block;"><b><span class="t18">28</span> jours</b><br />
                                <span class="t15"><b>24h/24</b></span></label></td>
                              <td width="95" class="bg_blanc bleu_fonce2"><label for="tarif_28j" style="display:block;"><span class="t18"><b>24&euro;</b></span><br />
	...
	?>
                  <span class="t13 bleu2 gras">Saisissez votre code promo :</span>
                  <form action="<?php print(URL_ADHERENT.'annonce/tarif.php');?>" method="post" class="code" style="margin-top:5px;">
                    <p>
          ...
          <td width="460"><table cellpadding="2">
              <tr>
                <td height="45" valign="middle" width="460" class="bg_orange2 blanc t18 gras" colspan="2">Consultation &agrave; la session : </td>
              </tr>
              <tr>
              ...
              <tr>
                <td height="235" valign="middle" class="bg_orange orange3" style="padding-top:5px; border:solid 1px #FF7602;"><span class="t15 gras">CHOIX 1 : R&eacute;glez par t&eacute;l&eacute;phone ou SMS</span><br />(facile, s&eacute;curis&eacute;, sans CB)<br /><br /><img src="<?php print(URL_ADHERENT.'image/paiement/sms.new.jpg');?>" alt="Envoyer LOC par SMS au 81 038*" /><br />
                  <b>OU</b><br />
                  <img src="<?php print(URL_ADHERENT.'image/paiement/tel.new.jpg');?>" alt="Appeler 0 899 23 08 89*" /><br />
                  <br />
                  <b>Saisissez ensuite ici le code que vous aurez obtenu :</b>
                  <br />
                  <form action="<?php print(URL_ADHERENT.'annonce/tarif.php');?>" method="post" class="code" style="margin-top:5px;">
                    <table cellpadding="0" cellspacing="0"><tr><td width="250" align="center">
                      ...
                      <input type="submit" class="submit simple3" name="annonce_submit" value="Valider" />
                    </td></tr></table>
                  </form>
                  <p class="petit" style="margin-top:5px;">
                    * SMS au <?php print(ma_htmlentities($plateforme['S1'][1]));?> au tarif de <?php print(ma_htmlentities($plateforme['S1'][2]));?>&euro;+prix du sms.<br />
              ...
              <tr>
                <td height="180" valign="middle" align="center" class="bg_orange orange3" style="margin-top:2px;"><script type="text/javascript">
	  <!--
	  document.write('<span class="t15 gras">CHOIX 2 : R&eacute;glez avec votre facture internet</span><br /><br /><table cellpadding="0" cellspacing="0"><tr><td width="220"><a style="text-decoration:none;" href="<?php print(LIEN_WHA);?>" id="wha"><img src="<?php print(URL_ADHERENT.'image/paiement/wha.new.jpg');?>" alt="wha" /></a></td><td width="150"><a style="text-decoration:none;" href="<?php print(LIEN_WHA);?>" id="wha"><input type="submit" class="submit simple3" name="annonce_submit" value="Valider" /></a></td></tr><tr><td colspan="2" align="center"><br />Montant de 1,50 &euro; d&eacute;bit&eacute; sur votre prochaine facture Internet</td></tr></table>');
	  -->
	  </script></td>
              </tr>
            </table></td>
    ...
    <p class="lien"><a class="orange2 gras decale20d" href="<?php print(URL_ADHERENT.'annonce/liste.php');?>">Retour &agrave; la liste d'annonces</a></p>
  </div>
