...
?>
            <tr>
			  ...
			  <!--
			  	document.write('<span class="js-liste-interrogation" title="Filtrez ici en fonction de votre rayon de recherche plus ou moins &eacute;loign&eacute; de la ville cibl&eacute;e.">?</span>');
			  //-->
              </script>
              </th>
              ...
              <script type="application/javascript">
			  <!--
			  	document.write('<span class="js-liste-interrogation" title="Filtrez ici par types d\'habitation (studio, T1, T2, T3, ...) indiquant le nombre de pi&egrave;ces.">?</span>');
			  //-->
              </script>
              </th>
