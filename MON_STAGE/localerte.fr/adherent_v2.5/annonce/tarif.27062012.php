<?php
	...
	//ABONNEMENT
	if(!isset($_REQUEST['tarif_abonnement_identifiant']) || !preg_match('/^(ab0013|ab0014|ab0015|ab0016)$/i',$_REQUEST['tarif_abonnement_identifiant']))
    ...
    <div class="tarif">
      ...
      <form action="<?php print(URL_ADHERENT.'annonce/tarif.php');?>" method="post" onsubmit="return GererWHA();" id="form_paiement">
        <table id="abonnement_tarif">
          ...
          <tr>
            <td><input type="radio" style="margin-left:15px;" name="tarif_abonnement_identifiant" id="abo16" value="ab0016"<?php if(isset($_REQUEST['tarif_abonnement_identifiant']) && ($_REQUEST['tarif_abonnement_identifiant']=='ab0016')) print(' checked="checked"');?> />
              <label for="abo16" style="cursor:pointer;"><span style="padding:5px; border:solid 2px #FFF; color:#FFF; background-color:#195292; display:inline-block; width:140px;">Abonnement de 21 jours</span> <span style="padding:5px; border:solid 2px #F49737; color:#F49737; background-color:#FFF; display:inline-block; width:40px;">19&euro;</span></label></td>
