<?php
	...
	if(isset($_REQUEST['code_reference']))
	{
		...
		if(!isset($_SESSION['code_reference']))
		{
			...
			$socket->executer();
			if(isset($socket->resultat_entete['Location']) && strpos($socket->resultat_entete['Location'],'http://www.localerte.fr/adh'.'erent/message/message.php?message_submit=code_allopass')===false)
			{
