<?php
	...
	$tarif_possible=array('ab0013','ab0014','ab0017','ab0015','ab0023');
	$tarif_defaut='';
...
<div class="style2">
  ...
  <div class="section mes-paiements">
    ...
    <h2>Comment consulter les annonces du jour ?</h2>
    ...
    <div class="etiquette paybox<?php if($selected) print($selected=='paybox-2euros'?' selected':' unselected');?>">
      ...
      <p class="tarif"><a href="mes-paiements.php?tarif_abonnement_identifiant=ab0023&amp;paiement_mode=CB&amp;annonce_submit=Valider">3&euro;</a></p>
    </div>
    <div class="etiquette wha<?php if($selected) print($selected=='wha-2euros'?' selected':' unselected');?>">
      ...
      <p class="tarif"><a href="mes-paiements.php?tarif_abonnement_identifiant=ab0023&amp;paiement_mode=WHA&amp;annonce_submit=Valider">3&euro;</a></p>
    </div>
    <div class="etiquette allopass<?php if($selected) print($selected=='allopass'?' selected':' unselected');?>">
      ...
      <div class="clear"></div>
      <form action="mes-paiements.php" method="get">
        <?php
    ...
    <div class="etiquette paybox<?php if($selected) print($selected=='paybox-7euros'?' selected':' unselected');?>">
      <h4>Carte bancaire</h4>
      <p class="accroche">Plate-forme s&eacute;curis&eacute;e Paybox</p>
      <p class="tarif long"><span>&agrave; partir de 7&euro;</span></p>
      <p class="montant"><a href="mes-paiements.php?tarif_abonnement_identifiant=ab0013&amp;paiement_mode=CB&amp;annonce_submit=Valider"><strong>7 jours</strong> <em>7 &euro;</em></a></p>
      <p class="montant"><a href="mes-paiements.php?tarif_abonnement_identifiant=ab0014&amp;paiement_mode=CB&amp;annonce_submit=Valider"><strong>14 jours</strong> <em>13 &euro;</em></a></p>
      <p class="montant"><a href="mes-paiements.php?tarif_abonnement_identifiant=ab0017&amp;paiement_mode=CB&amp;annonce_submit=Valider"><strong>21 jours</strong> <em>18 &euro;</em></a></p>
      <p class="montant"><a href="mes-paiements.php?tarif_abonnement_identifiant=ab0015&amp;paiement_mode=CB&amp;annonce_submit=Valider"><strong>28 jours</strong> <em>24 &euro;</em></a></p>
      <div class="clear"></div>
    </div>
    <div class="etiquette wha<?php if($selected) print($selected=='wha-7euros'?' selected':' unselected');?>">
      ...
      <p class="accroche">R&eacute;glez avec votre facture Internet</p>
      <p class="tarif long"><span>&agrave; partir de 7&euro;</span></p>
      <p class="montant"><a href="mes-paiements.php?tarif_abonnement_identifiant=ab0013&amp;paiement_mode=WHA&amp;annonce_submit=Valider"><strong>7 jours</strong> <em>7 &euro;</em></a></p>
      <p class="montant"><a href="mes-paiements.php?tarif_abonnement_identifiant=ab0014&amp;paiement_mode=WHA&amp;annonce_submit=Valider"><strong>14 jours</strong> <em>13 &euro;</em></a></p>
      <p class="montant"><a href="mes-paiements.php?tarif_abonnement_identifiant=ab0017&amp;paiement_mode=WHA&amp;annonce_submit=Valider"><strong>21 jours</strong> <em>18 &euro;</em></a></p>
      <p class="montant"><a href="mes-paiements.php?tarif_abonnement_identifiant=ab0015&amp;paiement_mode=WHA&amp;annonce_submit=Valider"><strong>28 jours</strong> <em>24 &euro;</em></a></p>
      <div class="clear"></div>
    </div>
    <div>
      <p class="retour"><a class="bouton" href="ma-liste.php">Retour &agrave; votre s&eacute;lection</a></p>
