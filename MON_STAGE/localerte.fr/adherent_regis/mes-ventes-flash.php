<?php
	if($paiement!='/mes-ventes-flash.php')
	{
		require_once(__DIR__.$paiement);
		die();
	}
	
	$tarif_possible=array('vf0001','vf0002','vf0003','vf0004','ab0023');
	$tarif_defaut='';
...
<div class="style2">
  ...
  <div class="section mes-paiements mes-ventes-flash">
    <div class="vente-flash-01">
      <p>VENTE FLASH : reste <span class="timer"><?php print(date('r',$minuteur));?></span></p>
      <p>Les abonnements sont moins cher. Profitez-en !</p>
    </div>
    ...
    <div class="etiquette paybox<?php if($selected) print($selected=='paybox-7euros'?' selected':' unselected');?>">
      ...
      <p class="montant"><a href="mes-ventes-flash.php?tarif_abonnement_identifiant=vf0001&amp;paiement_mode=CB&amp;annonce_submit=Valider"><strong>7 jours</strong> <em>5 &euro; <del>7 &euro;</del></em></a></p>
      <p class="montant"><a href="mes-ventes-flash.php?tarif_abonnement_identifiant=vf0002&amp;paiement_mode=CB&amp;annonce_submit=Valider"><strong>14 jours</strong> <em>10 &euro; <del>13 &euro;</del></em></a></p>
      <p class="montant"><a href="mes-ventes-flash.php?tarif_abonnement_identifiant=vf0003&amp;paiement_mode=CB&amp;annonce_submit=Valider"><strong>21 jours</strong> <em>13 &euro; <del>18 &euro;</del></em></a></p>
      <p class="montant"><a href="mes-ventes-flash.php?tarif_abonnement_identifiant=vf0004&amp;paiement_mode=CB&amp;annonce_submit=Valider"><strong>28 jours</strong> <em>17 &euro; <del>24 &euro;</del></em></a></p>
      <div class="clear"></div>
    </div>
    <div class="etiquette wha<?php if($selected) print($selected=='wha-7euros'?' selected':' unselected');?>">
      ...
      <p class="tarif long"><span>&agrave; partir de 5&euro;</span></p>
      <p class="montant"><a href="mes-ventes-flash.php?tarif_abonnement_identifiant=vf0001&amp;paiement_mode=WHA&amp;annonce_submit=Valider"><strong>7 jours</strong> <em>5 &euro; <del>7 &euro;</del></em></a></p>
      <p class="montant"><a href="mes-ventes-flash.php?tarif_abonnement_identifiant=vf0002&amp;paiement_mode=WHA&amp;annonce_submit=Valider"><strong>14 jours</strong> <em>10 &euro; <del>13 &euro;</del></em></a></p>
      <p class="montant"><a href="mes-ventes-flash.php?tarif_abonnement_identifiant=vf0003&amp;paiement_mode=WHA&amp;annonce_submit=Valider"><strong>21 jours</strong> <em>13 &euro; <del>18 &euro;</del></em></a></p>
      <p class="montant"><a href="mes-ventes-flash.php?tarif_abonnement_identifiant=vf0004&amp;paiement_mode=WHA&amp;annonce_submit=Valider"><strong>28 jours</strong> <em>17 &euro; <del>24 &euro;</del></em></a></p>
      <div class="clear"></div>
    </div>
    ...
    <div class="etiquette paybox<?php if($selected) print($selected=='paybox-2euros'?' selected':' unselected');?>">
      <h4>Carte bancaire</h4>
      <p class="accroche">Plate-forme s&eacute;curis&eacute;e Paybox</p>
      <p class="tarif"><a href="mes-ventes-flash.php?tarif_abonnement_identifiant=ab0023&amp;paiement_mode=CB&amp;annonce_submit=Valider">3&euro;</a></p>
    </div>
    <div class="etiquette wha<?php if($selected) print($selected=='wha-2euros'?' selected':' unselected');?>">
      <h4>Internet+</h4>
      <p class="accroche">R&eacute;glez avec votre facture Internet</p>
      <p class="tarif"><a href="mes-ventes-flash.php?tarif_abonnement_identifiant=ab0023&amp;paiement_mode=WHA&amp;annonce_submit=Valider">3&euro;</a></p>
    </div>
    <div class="etiquette allopass<?php if($selected) print($selected=='allopass'?' selected':' unselected');?>">
      ...
      <div class="clear"></div>
      <form action="mes-ventes-flash.php" method="get">
        <?php
