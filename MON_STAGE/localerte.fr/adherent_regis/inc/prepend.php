<?php
	...
	define('URL_ADHERENT_PUBLIC','/adherent');
	define('PWD_ADHERENT_PUBLIC',$_SERVER['DOCUMENT_ROOT'].URL_ADHERENT_PUBLIC);
	define('HTTP_ADHERENT_PUBLIC','http'.(HTTPS?'s':'').'://www.localerte.fr'.URL_ADHERENT_PUBLIC);
	define('HTTP_STATIC','http'.(HTTPS?'s':'').'://static.localerte.fr'.URL_ADHERENT_PUBLIC);
	...
	//		header('location: '.url_use_trans_sid(URL_ADHERENT_PUBLIC.'annonce/tarif.php'));
	//		die();
	//	}
	//}
