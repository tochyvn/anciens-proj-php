<?php
			...
			else
			{
				...
				('
					...
					where reference=\''.addslashes($_REQUEST['code_reference']).'\'
						...
						(
							(
								date_premiere_connexion<=\'2013-09-30 08:00:00\'
								and adddate(date_premiere_connexion, interval 2 day)>=now()
							)
							or
							(
								date_premiere_connexion>\'2013-09-30 08:00:00\'
			...
			else
			{
				...
				('
					...
					where reference=\''.addslashes($_REQUEST['code_reference']).'\'
						...
						(
							(
								enregistrement<=\'2013-09-30 08:00:00\'
								and adddate(enregistrement, interval 2 day)>=now()
							)
							or
							(
								enregistrement>\'2013-09-30 08:00:00\'
	...
	if(isset($_SESSION['WHA_PAYE']) && $_REQUEST['acte']=='LA002')
	{
		...
		$delai=(time()<=mktime(8,0,0,9,30,2013)?2:1);
