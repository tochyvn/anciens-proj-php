<?php
	...
	$tarif_possible=array('vf0001','vf0002','vf0003','vf0004');
	$tarif_defaut='vf0004';
...
<div class="style2">
  ...
  <div class="gauche">
    ...
    <div class="info">
      <h3><strong>Offre Sp&eacute;cial rentr&eacute;e jusqu&rsquo;au 30 septembre &agrave; 08 h</strong></h3>
      <p>Apr&egrave;s avoir re&ccedil;u (par SMS ou t&eacute;l&eacute;phone) et entr&eacute; votre code d&rsquo;acc&egrave;s, vous acc&eacute;dez librement  24h sur 24 et pendant 48 h aux annonces relev&eacute;es par Localerte. Vous pouvez vous connecter autant de fois que vous le souhaitez et votre mini abonnement prend fin 48h apr&egrave;s la prem&egrave;re saisie du code.</p>
  ...
  <div class="section mes-paiements mes-ventes-flash">
    ...
    <h3><strong>Pour visualiser toutes les annonces 24H/24,</strong></h3>
    <form action="mes-ventes-flash.php" method="post" class="abonnement">
      <?php
    ...
    ?>
      <p class="montant">
        <label><strong>7 jours</strong> <em>5 &euro; <del>(7 &euro;)</del></em>
          <input type="radio" name="tarif_abonnement_identifiant" value="vf0001"<?php if(isset($_REQUEST['tarif_abonnement_identifiant']) && ($_REQUEST['tarif_abonnement_identifiant']=='vf0001')) print(' checked="checked"');?>>
        </label>
        <label><strong>14 jours</strong> <em>10 &euro; <del>(13 &euro;)</del></em>
          <input type="radio" name="tarif_abonnement_identifiant" value="vf0002"<?php if(isset($_REQUEST['tarif_abonnement_identifiant']) && ($_REQUEST['tarif_abonnement_identifiant']=='vf0002')) print(' checked="checked"');?>>
        </label>
        <label><strong>21 jours</strong> <em>13 &euro; <del>(18 &euro;)</del></em>
          <input type="radio" name="tarif_abonnement_identifiant" value="vf0003"<?php if(isset($_REQUEST['tarif_abonnement_identifiant']) && ($_REQUEST['tarif_abonnement_identifiant']=='vf0003')) print(' checked="checked"');?>>
        </label>
        <label><strong>28 jours</strong> <em>17 &euro; <del>(24 &euro;)</del></em>
          <input type="radio" name="tarif_abonnement_identifiant" value="vf0004"<?php if(isset($_REQUEST['tarif_abonnement_identifiant']) && ($_REQUEST['tarif_abonnement_identifiant']=='vf0004')) print(' checked="checked"');?>>
        </label>
      </p>
      <p class="mode">
        <label>
    ...
    <hr class="orange">
    <h3><strong>Pour visualiser toutes les annonces 24h sur 24 pendant 2 jours,</strong> vous avez besoin d'un code que vous pouvez obtenir par SMS ou par téléphone* : </h3>
    <form action="mes-ventes-flash.php" method="get" class="code">
      <?php
...
?>
      ...
      <div class="ddd">
        <p class="label">Saisissez le code d&eacute;livr&eacute; ici</p> 
        <p class="champ">
...
?>
      ...
      <p class="cache">
        ...
        <input type="hidden" name="mp_r" value="<?php print(HTTP_ADHERENT.'/mes-ventes-flash.php');?>">
        <input type="hidden" name="mp_acte" value="LA002">
      </p>
    </form>
    <hr class="orange">
    <h3>Si vous disposez d'un Code promo, merci de le saisir ici :</h3>
    <form action="mes-ventes-flash.php" method="get" class="gratuit">
      <?php
