<?php
	...
	define('DEPARTEMENT_IDENTIFIANT_DEFAUT',NULL);
	define('DEPARTEMENT_REGION_DEFAUT',NULL);
	define('DEPARTEMENT_NOM_DEFAUT',NULL);
	
	class ld_departement extends ld_sql
	{
		private /*var*/ $champs;
		...
		{
			$this->champs=array();
			$this->champs['identifiant']=DEPARTEMENT_IDENTIFIANT_DEFAUT;
			$this->champs['region']=DEPARTEMENT_REGION_DEFAUT;
			$this->champs['nom']=DEPARTEMENT_NOM_DEFAUT;
		...
		public function lire()
		{
			...
			$this->champs['region']=$occurrence['region'];
