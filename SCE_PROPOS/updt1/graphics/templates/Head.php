...
class Head {
    ...
    function getMenu() {
       ...
       $wind = new Li(new Text('Windows'));
       $sous_wind = new Ul();
       $sous_wind->addLis(array (new Li(new A(new Text('Composants'), $host.'composants')),
           new Li(new A(new Text('Propriétés'),$host.'proprietes')),
           new Li(new A(new Text('Concepteur'),$host.'concepteur')),
           new Li(new A(new Text('Wind-code'),$host.'windcode')),
           new Li(new A(new Text('Groupe'),$host.'groupe'))));
       ...
       $menu->addLis(array($fichier,$edit,$simul,$wind,$help));
       echo $menu->toHTML();
