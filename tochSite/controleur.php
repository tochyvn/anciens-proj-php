...
$actions = array("accueil"=>0, "connexion"=>0, "deconnexion"=>1, "inscription"=>0,
    "ajoutEncheres"=>3, "achatJetons"=>1,"ajoutArticle"=>3);
...
try {
    ...
    $manager->setConfiguration(array(
        'dsn' => 'mysql:host=localhost;port=3306;dbname=SITE_ENCHERES',
        'user' => 'root',
        'password' => 'root',
    ));
