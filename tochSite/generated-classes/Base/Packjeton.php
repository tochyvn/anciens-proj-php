...
/**
 * Base class that represents a row from the 'PACKJETON' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Packjeton implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PackjetonTableMap';
    ...
    /**
     * The value for the jetons field.
     * @var        int
     */
    protected $jetons;
    ...
    /**
     * Initializes internal state of Base\Packjeton object.
     */
    ...
    /**
     * Compares this with another <code>Packjeton</code> instance.  If
     * <code>obj</code> is an instance of <code>Packjeton</code>, delegates to
     * <code>equals(Packjeton)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Packjeton The current object, for fluid interface
     */
     ...
     * @return $this|\Packjeton The current object (for fluent API support)
     */
    public function setIdPack($v)
    {
        ...
        if ($this->id_pack !== $v) {
            $this->id_pack = $v;
            $this->modifiedColumns[PackjetonTableMap::COL_ID_PACK] = true;
        }
    ...
    /**
     * Set the value of [jetons] column.
     *
     * @param int $v new value
     * @return $this|\Packjeton The current object (for fluent API support)
     */
    public function setJetons($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->jetons !== $v) {
            $this->jetons = $v;
            $this->modifiedColumns[PackjetonTableMap::COL_JETONS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PackjetonTableMap::translateFieldName('IdPack', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_pack = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PackjetonTableMap::translateFieldName('Jetons', TableMap::TYPE_PHPNAME, $indexType)];
            $this->jetons = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = PackjetonTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Packjeton'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPackjetonQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Packjeton::setDeleted()
     * @see Packjeton::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPackjetonQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PackjetonTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[PackjetonTableMap::COL_ID_PACK] = true;
        if (null !== $this->id_pack) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . PackjetonTableMap::COL_ID_PACK . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(PackjetonTableMap::COL_ID_PACK)) {
            $modifiedColumns[':p' . $index++]  = 'id_pack';
        }
        if ($this->isColumnModified(PackjetonTableMap::COL_JETONS)) {
            $modifiedColumns[':p' . $index++]  = 'jetons';
        }

        $sql = sprintf(
            'INSERT INTO PACKJETON (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id_pack':
                        ...
                        break;
                    case 'jetons':
                        $stmt->bindValue($identifier, $this->jetons, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = PackjetonTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Packjeton'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Packjeton'][$this->hashCode()] = true;
        $keys = PackjetonTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdPack(),
            $keys[1] => $this->getJetons(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdPack($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setJetons($arr[$keys[1]]);
        }
    }
    ...
    {
        $criteria = new Criteria(PackjetonTableMap::DATABASE_NAME);

        if ($this->isColumnModified(PackjetonTableMap::COL_ID_PACK)) {
            $criteria->add(PackjetonTableMap::COL_ID_PACK, $this->id_pack);
        }
        if ($this->isColumnModified(PackjetonTableMap::COL_JETONS)) {
            $criteria->add(PackjetonTableMap::COL_JETONS, $this->jetons);
        }
    ...
    {
        $criteria = ChildPackjetonQuery::create();
        $criteria->add(PackjetonTableMap::COL_ID_PACK, $this->id_pack);
    ...
    /**
     * Generic method to set the primary key (id_pack column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Packjeton (or compatible) type.
    ...
    {
        $copyObj->setJetons($this->getJetons());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdPack(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Packjeton Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildPackjeton is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildPackjeton The current object (for fluent API support)
     */
    public function setAchats(Collection $achats, ConnectionInterface $con = null)
    {
        ...
        foreach ($achatsToDelete as $achatRemoved) {
            $achatRemoved->setPackjeton(null);
        }
     ...
     * Otherwise if this Packjeton is new, it will return
     * an empty collection; or if this Packjeton has previously
     * been saved, it will retrieve related Achats from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Packjeton.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildAchat[] List of ChildAchat objects
     */
    public function getAchatsJoinUser(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildAchatQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(PackjetonTableMap::DEFAULT_STRING_FORMAT);
    }
