 ...
 * @method     ChildEnchereQuery orderByHeureDebut($order = Criteria::ASC) Order by the heure_debut column
 * @method     ChildEnchereQuery orderByDateFin($order = Criteria::ASC) Order by the date_fin column
 * @method     ChildEnchereQuery orderByHeureFin($order = Criteria::ASC) Order by the heure_fin column
 ...
 * @method     ChildEnchereQuery groupByHeureDebut() Group by the heure_debut column
 * @method     ChildEnchereQuery groupByDateFin() Group by the date_fin column
 * @method     ChildEnchereQuery groupByHeureFin() Group by the heure_fin column
 ...
 * @method     ChildEnchere findOneByHeureDebut(string $heure_debut) Return the first ChildEnchere filtered by the heure_debut column
 * @method     ChildEnchere findOneByDateFin(string $date_fin) Return the first ChildEnchere filtered by the date_fin column
 * @method     ChildEnchere findOneByHeureFin(string $heure_fin) Return the first ChildEnchere filtered by the heure_fin column
 ...
 * @method     ChildEnchere requireOneByHeureDebut(string $heure_debut) Return the first ChildEnchere filtered by the heure_debut column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildEnchere requireOneByHeureFin(string $heure_fin) Return the first ChildEnchere filtered by the heure_fin column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildEnchere[]|ObjectCollection findByHeureDebut(string $heure_debut) Return ChildEnchere objects filtered by the heure_debut column
 ...
 * @method     ChildEnchere[]|ObjectCollection findByHeureFin(string $heure_fin) Return ChildEnchere objects filtered by the heure_fin column
...
abstract class EnchereQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'SITE_ENCHERES', $modelName = '\\Enchere', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id_ench, date_debut, heure_debut, date_fin, heure_fin, id_art FROM ENCHERE WHERE id_ench = :p0';
        try {
    ...
    /**
     * Filter the query on the heure_debut column
     *
     * Example usage:
     * <code>
     * $query->filterByHeureDebut('2011-03-14'); // WHERE heure_debut = '2011-03-14'
     * $query->filterByHeureDebut('now'); // WHERE heure_debut = '2011-03-14'
     * $query->filterByHeureDebut(array('max' => 'yesterday')); // WHERE heure_debut > '2011-03-13'
     * </code>
     *
     * @param     mixed $heureDebut The value to use as filter.
     *              Values can be integers (unix timestamps), DateTime objects, or strings.
     *              Empty strings are treated as NULL.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     ...
     * @return $this|ChildEnchereQuery The current query, for fluid interface
     */
    public function filterByHeureDebut($heureDebut = null, $comparison = null)
    {
        if (is_array($heureDebut)) {
            $useMinMax = false;
            if (isset($heureDebut['min'])) {
                $this->addUsingAlias(EnchereTableMap::COL_HEURE_DEBUT, $heureDebut['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($heureDebut['max'])) {
                $this->addUsingAlias(EnchereTableMap::COL_HEURE_DEBUT, $heureDebut['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(EnchereTableMap::COL_HEURE_DEBUT, $heureDebut, $comparison);
    }
    ...
    /**
     * Filter the query on the heure_fin column
     *
     * Example usage:
     * <code>
     * $query->filterByHeureFin('2011-03-14'); // WHERE heure_fin = '2011-03-14'
     * $query->filterByHeureFin('now'); // WHERE heure_fin = '2011-03-14'
     * $query->filterByHeureFin(array('max' => 'yesterday')); // WHERE heure_fin > '2011-03-13'
     * </code>
     *
     * @param     mixed $heureFin The value to use as filter.
     *              Values can be integers (unix timestamps), DateTime objects, or strings.
     *              Empty strings are treated as NULL.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     ...
     * @return $this|ChildEnchereQuery The current query, for fluid interface
     */
    public function filterByHeureFin($heureFin = null, $comparison = null)
    {
        if (is_array($heureFin)) {
            $useMinMax = false;
            if (isset($heureFin['min'])) {
                $this->addUsingAlias(EnchereTableMap::COL_HEURE_FIN, $heureFin['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($heureFin['max'])) {
                $this->addUsingAlias(EnchereTableMap::COL_HEURE_FIN, $heureFin['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(EnchereTableMap::COL_HEURE_FIN, $heureFin, $comparison);
    }
