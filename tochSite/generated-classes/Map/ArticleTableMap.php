...
class ArticleTableMap extends TableMap
{
     ...
     */
    const COL_ID_ART = 'ARTICLE.id_art';

    /**
     * the column name for the nom_art field
     */
    const COL_NOM_ART = 'ARTICLE.nom_art';

    /**
     * the column name for the prix field
     */
    const COL_PRIX = 'ARTICLE.prix';

    /**
     * the column name for the path field
     */
    const COL_PATH = 'ARTICLE.path';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdArt', 'NomArt', 'Prix', 'Path', ),
        self::TYPE_CAMELNAME     => array('idArt', 'nomArt', 'prix', 'path', ),
        self::TYPE_COLNAME       => array(ArticleTableMap::COL_ID_ART, ArticleTableMap::COL_NOM_ART, ArticleTableMap::COL_PRIX, ArticleTableMap::COL_PATH, ),
        self::TYPE_FIELDNAME     => array('id_art', 'nom_art', 'prix', 'path', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdArt' => 0, 'NomArt' => 1, 'Prix' => 2, 'Path' => 3, ),
        self::TYPE_CAMELNAME     => array('idArt' => 0, 'nomArt' => 1, 'prix' => 2, 'path' => 3, ),
        self::TYPE_COLNAME       => array(ArticleTableMap::COL_ID_ART => 0, ArticleTableMap::COL_NOM_ART => 1, ArticleTableMap::COL_PRIX => 2, ArticleTableMap::COL_PATH => 3, ),
        self::TYPE_FIELDNAME     => array('id_art' => 0, 'nom_art' => 1, 'prix' => 2, 'path' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('id_art', 'IdArt', 'INTEGER', true, null, null);
        $this->addColumn('nom_art', 'NomArt', 'VARCHAR', true, 50, null);
        $this->addColumn('prix', 'Prix', 'DECIMAL', true, null, null);
        $this->addColumn('path', 'Path', 'VARCHAR', false, 50, null);
    } // initialize()
  ...
  array (
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdArt', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdArt', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    public static function getPrimaryKeyFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        return (int) $row[
            $indexType == TableMap::TYPE_NUM
                ? 0 + $offset
                : self::translateFieldName('IdArt', TableMap::TYPE_PHPNAME, $indexType)
        ];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ArticleTableMap::COL_ID_ART);
            $criteria->addSelectColumn(ArticleTableMap::COL_NOM_ART);
            $criteria->addSelectColumn(ArticleTableMap::COL_PRIX);
            $criteria->addSelectColumn(ArticleTableMap::COL_PATH);
        } else {
            $criteria->addSelectColumn($alias . '.id_art');
            $criteria->addSelectColumn($alias . '.nom_art');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ArticleTableMap::COL_ID_ART, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(ArticleTableMap::COL_ID_ART) && $criteria->keyContainsValue(ArticleTableMap::COL_ID_ART) ) {
