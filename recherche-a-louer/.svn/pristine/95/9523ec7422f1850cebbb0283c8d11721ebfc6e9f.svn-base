...
*/
	...
	public function views($name, $data = array())
	{
        ...
        public function setVar( $params ){
            foreach( $params as $key => $param){
                $this->var[ $key ] = $param; 
            }
        }
        
        // charger la vue des filtres contenu dans le header
        public function loadFilter( $param ){
            $this->var['filters'] = $this->CI->load->view( 'front/annonce/filtre_superieur', $param, true );
        }
}