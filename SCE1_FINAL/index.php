...
<html>
    <head>
        ...
        <script type="text/javascript" src="graphics/scripts/jquery-ui-plagin/jquery.min.js"></script>
        <script type="text/javascript" src="graphics/scripts/jquery-ui-plagin/jquery-ui.min.js"></script>
        <!--
