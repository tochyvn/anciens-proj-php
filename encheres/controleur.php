...
try {
    ...
    $serviceContainer->setAdapterClass('siteEncheres', 'mysql');
    $manager = new ConnectionManagerSingle();
    $manager->setConfiguration(array(
        'dsn' => 'mysql:host=localhost;port=8889;dbname=siteEncheres',
        'user' => 'root',
        'password' => 'root',
    ));
    $serviceContainer->setConnectionManager('siteEncheres', $manager);
